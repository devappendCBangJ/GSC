...
parser.add_argument('--resume-checkpoint-path', default='', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
# 1-3) Transfer Learning - Pre Trained Model 사용 유무
parser.add_argument('--pretrained', dest='pretrained', action='store_true',
                    help='use pre-trained model')
# 1-4) Transfer Learning - Saved Path
parser.add_argument('--pretrained_model_path', default='', type=str, metavar='WEIGHT', # transfer learng 사용 시 : default : 'mobilenetv2_1.0-0c6065bc.pth'
                    help='path to pretrained weight (default: none)')

# 2-1) Dataset Path
parser.add_argument('-d', '--data', metavar='DIR', default='/media/hi/SK Gold P31/Korean_Emotion_Movie/', # 기존 : default 존재하지 않음 -> "/home/hi/Datasets/Cifar10/"
...
# 5-2) Train Epochs
parser.add_argument('--epochs', default=150, type=int, metavar='N', # 기존 : 90 -> 150
...
parser.add_argument('-c', '--checkpoint-path', default='checkpoints', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoints)')

# 7) Evaluate
parser.add_argument('-e', '--evaluate', dest='evaluate', default=False, # 기존 : action='store_true', default는 없음
